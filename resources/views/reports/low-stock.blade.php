<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Low Stock Report</h2>
                <p class="text-sm text-gray-500 mt-1">Medicines that are at or below reorder level.</p>
            </div>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow rounded-xl p-6">
                <form method="GET" action="{{ route('reports.low-stock') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-4 py-4 text-center text-gray-500">No low stock medicines found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
